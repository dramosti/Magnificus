...
namespace HLP.Comum.Models
{
    ...
    public class ConfigFormulariosModel
    {
        ...
        public int? idFormularios
        {
            ...
            set
            {
                ...
                SetidFormulariosTabPageRecursivo(lConfigTabPage, Convert.ToInt32(value));
            }
        }
        [ParameterOrder(Order = 2)]
        ...
        private void SetidFormulariosTabPageRecursivo(List<ConfigTabPageModel> lConfigTab, int value)
        {
            foreach (ConfigTabPageModel objConfigTab in lConfigTab)
            {
                objConfigTab.idFormularios = value;

                if (objConfigTab.lConfigTabPageModel != null)
                {
                    SetidFormulariosTabPageRecursivo(objConfigTab.lConfigTabPageModel, value);
                }
    ...
    public class ConfigTabPageModel
    {
        ...
        public int? idTabPage
        {
            ...
            set
            {
                ...
                if (value != null)
                {
                    this.objConfigTabPageUsu.idTabPage = Convert.ToInt32(value);
                    foreach (ConfigComponenteModel comp in this.lConfigComponente)
                    {
                        comp.idTabPage = Convert.ToInt32(value);
                    }
                }
    ...
    public class ConfigComponenteModel
    {
        ...
        /// </summary>
        private InfoFieldModel _Base;

        public InfoFieldModel Base
        {
            get { return _Base; }
            set { _Base = value; }
        }
