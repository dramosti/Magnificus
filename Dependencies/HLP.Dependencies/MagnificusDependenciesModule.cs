...
using HLP.Comum.Repository.Implementation;
using HLP.Comum.Repository.Interfaces;
using HLP.Comum.Services.Implementation;
using HLP.Comum.Services.Interface;
using HLP.Repository.Implementation;
using HLP.Repository.Implementation.Entries;
using HLP.Repository.Implementation.Entries.Comercial;
using HLP.Repository.Implementation.Entries.CRM;
using HLP.Repository.Implementation.Entries.Financeiro;
using HLP.Repository.Implementation.Entries.Fiscal;
using HLP.Repository.Implementation.Entries.Gerais;
...
using HLP.Services.Implementation.Entries.Comercial;
using HLP.Services.Implementation.Entries.CRM;
using HLP.Services.Implementation.Entries.Financeiro;
using HLP.Services.Implementation.Entries.Fiscal;
using HLP.Services.Implementation.Entries.Gerais;
using HLP.Services.Implementation.Entries.Parametros;
...
using HLP.Repository.Implementation.Entries.Parametros;
using HLP.Repository.Implementation.Entries.RecursosHumanos;
using HLP.Repository.Interfaces.Entries.RecursosHumanos;
using HLP.Services.Implementation.Entries.RecursosHumanos;
...
using HLP.Comum.Services.Implementation.Configuracao;
using HLP.Comum.Repository.Implementation.Configuracao;
using HLP.Services.Interfaces.Sales.Comercial;
using HLP.Services.Implementation.Sales.Comercial;
using HLP.Repository.Interfaces.Sales.Comercial;
using HLP.Repository.Implementation.Sales.Comercial;
